...
half _PSX_FlatShadingMode;
#endif

half _PSX_VertexWobbleMode;
...
#ifdef PSX_VERTEX_LIT
		half3 viewNormal = normalize(mul((float3x3)UNITY_MATRIX_IT_MV, IN[i].normal));
...
#else
half4 frag(g2f i, UNITY_VPOS_TYPE screenPos : SV_POSITION) : COLOR
#endif
{
	fragOut o;
